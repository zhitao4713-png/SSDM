"""
SSDM Attention-based Diffusion Attacker (Refactored)
=====================================================
This module implements the cross-attention manipulation pipeline 
for evaluating watermark robustness against diffusion-based attacks.
"""
...
class SSDMReSDPipeline(StableDiffusionPipeline):
    @torch.no_grad()
    def __call__(
        self,
